...
#'
#' Take files with the raw medication extraction output generated by the MedEx 
...
#' MedEx output files anchor extractions to a specific drug name extraction. In the case 
