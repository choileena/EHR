...
#'
#' Take files with the raw medication extraction output generated by the CLAMP 
...
#' semantic relations. In the case where multiple entities are extracted for the same 
