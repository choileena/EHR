...
#'
#' Take files with the raw medication extraction output generated by the medExtractR 
...
#' (see Weeks, et al. 2020 for details). In the case where multiple entities are extracted 
