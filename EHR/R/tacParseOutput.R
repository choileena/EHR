...
#'
#' The output after running \code{\link{parseMedExtractR}} on 3 example clinical notes.
#'
#' @format A data frame with 7 observations on the following variables.
#' \describe{
...
#' }
#'
#' @usage data(tac_mxr_parsed, package = 'EHR')
#'
#' @keywords datasets
#'
#' @examples
